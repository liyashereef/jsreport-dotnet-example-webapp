...
use Modules\Recruitment\Models\RecCandidateScreeningPersonalityInventory;

class RecCandidateScreeningPersonalityInventoryRepository
{
    ...
    {
        $this->model = new RecCandidateScreeningPersonalityInventory;
    }
