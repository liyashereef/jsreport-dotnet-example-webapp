...
use Modules\Recruitment\Models\RecEnglishRatingLookup;

class RecEnglishRatingLookupRepository
{
     ...
     * @return void
     */
    public function __construct(RecEnglishRatingLookup $recEnglishRatingLookup)
    {
        $this->model = $recEnglishRatingLookup;
    }
