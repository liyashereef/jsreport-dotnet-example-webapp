...
class RecBrandAwarenessRepository
{
    /**
     * The Model instance.
     * ''
     ...
     *
     * @param  \App\Models\RecBrandAwareness $recBrandAwareness
     */
    public function __construct(RecBrandAwareness $recBrandAwareness)
    {
        $this->model = $recBrandAwareness;
    }
