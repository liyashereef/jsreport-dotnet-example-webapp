...
class RecCompetencyMatrixCategoryLookupRepository
{
    /**
     * The Model instance.
     * ''
     ...
     *
     * @param  Modules\Recruitment\Models\RecCompetencyMatrixCategoryLookup $recCompetencyMatrixCategoryLookup
     */
    public function __construct(
        RecCompetencyMatrixCategoryLookup $recCompetencyMatrixCategoryLookup,
        RecCompetencyMatrixLookupRepository $recCompetency_matrix_repository
        )
    {
        $this->model = $recCompetencyMatrixCategoryLookup;
        $this->competency_matrix_repository = $recCompetency_matrix_repository;
    }
