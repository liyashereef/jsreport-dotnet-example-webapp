...
use DB;
use Modules\Recruitment\Models\RecCompetencyMatrixLookup;

class RecCompetencyMatrixLookupRepository
{
    /**
     * The Model instance.
     * ''
     ...
     *
     * @param  \Modules\Recruitment\Models\RecCompetencyMatrixLookup $recCompetencyMatrixLookup
     */
    public function __construct(RecCompetencyMatrixLookup $recCompetencyMatrixLookup)
    {
        $this->model = $recCompetencyMatrixLookup;
    }
    ...
    public function getCompetency()
    {
        ...
        foreach ($result as $key => $competency) {
            ...
            $competency_array[$category_index]['competency'][$competency_index]['behavior'] = nl2br($competency->behavior);
            $competency_index++;
        }
        return $competency_array;
    }
