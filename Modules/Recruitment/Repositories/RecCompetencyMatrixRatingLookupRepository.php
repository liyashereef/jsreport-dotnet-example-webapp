...
use Modules\Recruitment\Models\RecCompetencyMatrixRatingLookup;

class RecCompetencyMatrixRatingLookupRepository
{
    /**
     * The Model instance.
     * ''
     ...
     *
     * @param  Modules\Recruitment\Models\RecCompetencyMatrixRatingLookup $recCompetencyMatrixRatingLookup
     */
    public function __construct(RecCompetencyMatrixRatingLookup $recCompetencyMatrixRatingLookup)
    {
        $this->model = $recCompetencyMatrixRatingLookup;
    }
