...
class RecCompetencyMatrixLookupRequest extends Request
{
    /**
    ...
    public function rules()
    {
        $id = request('id');
        return $rules = [
            'competency' => "bail|required|max:255|unique:mysql_rec.rec_competency_matrix_lookups,competency,{$id},id,deleted_at,NULL",
