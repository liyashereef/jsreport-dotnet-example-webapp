...
<div id="tech_summary" style="display:{{ isset($candidate->smart_phone_type_id)?'block':'none' }};">
    <div class="form-group row" id="smart_phone_type_id">
        ...
        <div class="col-sm-7">
            ...
            Select']+$lookups['smart_phones'],old('smart_phone_type_id',isset($candidate->smart_phone_type_id)
            ? $candidate->smart_phone_type_id :""),array('class' => 'form-control
            landing-form select2','required'=>isset($candidate->smart_phone_type_id))) }}
            <div class="form-control-feedback">
                <span class="help-block text-danger align-middle font-12"></span>
            </div>
        </div>
    ...
    <div class="form-group row" id="smart_phone_skill_level">
        ...
        <div class="col-sm-7">
            ...
            Knowledge"],old('smart_phone_skill_level',isset($candidate->smart_phone_skill_level) ?
            $candidate->smart_phone_skill_level :""),array('class' => 'form-control
            landing-form','required'=>isset($candidate->smart_phone_type_id))) }}
            <div class="form-control-feedback">
                <span class="help-block text-danger align-middle font-12"></span>
            </div>
        </div>
