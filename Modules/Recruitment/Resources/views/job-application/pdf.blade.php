...
{{--
            ...
            <div class="form-group row flex-nowarp">
                ...
                <div class="col-sm-3 float-left ">
                   ...
                   @if(isset($candidateJob->candidate->referalAvailibility->orientation))
                    {{ $candidateJob->candidate->referalAvailibility->orientation }}
                        @else
                            --
                    @endif
                    </span>
            ...
            <div class="page-break-after">
              ...
              {{--   @if(isset($candidateJob->candidate->referalAvailibility->position_availibility) && ($candidateJob->candidate->referalAvailibility->position_availibility == "1")
                ...
                <div class="form-group row flex-nowarp">
                    <div class="col-sm-8 float-left">
                        <label class="pdf-label-1">   How many hours per week would you prefer to work?</label>
                    </div>
                    <div class="col-sm-3 float-left ">
                    <span class="pdf-label-style pdf-border-normal">

                   {{$candidateJob->candidate->awareness->prefered_hours_per_week }}
                    </span>
                    </div>
                </div>
                <div class="form-group row flex-nowarp">
            ...
            <aside>
                <div class="form-group row flex-nowarp">
                    ...
                    <div class="col-sm-3 float-left hour">
                        <label class="pdf-text"> ${{number_format($candidateJob->candidate->wageexpectation->wage_expectations, 2)}}</label>
                      {{--   <label class="pdf-text hour-top"></label>
            ...
            @if(isset($candidateJob->candidate->availability->days_required))
                ...
                <div class="form-group row flex-nowarp">
                    ...
                    <div class="col-sm-3 float-sm-right">
                        <span class="pdf-label-style pdf-border-normal"> {!! $candidateJob->candidate->availability->days_required !!}</span>
                    </div>
                </div>
            ...
            @if($candidateJob->candidate->availability->shifts)
                ...
                <div class="form-group row flex-nowarp">
                    ...
                    <div class="col-sm-3 float-sm-right">
                        <span class="pdf-label-style pdf-border-normal"> {!! $candidateJob->candidate->availability->shifts !!}</span>
                    </div>
                </div>
            @endif
            <div class="clearfix"></div>
            ...
            @if($candidateJob->candidate->availability->available_shift_work == "No")
                    ...
                    @foreach ($candidateJob->candidate->uniform_measurements as $uniform_measure)
                        <div class="form-group row flex-nowarp">
                            ...
                            <div class="col-sm-2  ">
                                ...
                                ->uniform_measurement_points['name']}}</label>
                            </div>
                            <div class="col-sm-2   ">
                                <label class="pdf-label-1" style="font-size: 12px;">{{$uniform_measure['measurement_value']}} (Inches)</label>
                            </div>
                            <div class="col-sm-2   ">
                ...
                @foreach($candidateJob->candidate->languages as $each_language_skill)
                    ...
                    @if (isset($candidateJob->candidate->experience->current_employee_commissionaries))
                        <div class="form-group row flex-nowarp">
                            <div class="col-sm-8 float-left">
    ...
    @if($candidateJob->candidate->experience->employed_by_corps == "Yes")
     ...
     {{--    </aside> --}}
        ...
        @if(Auth::user()!=null)
            ...
            @endif
            {{-- @if(!$candidateJob->candidate->interviewnote->isEmpty())
            ...
            <div class="page-break">
                ...
                <aside>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3 float-right">
                            <span class="pdf-label-style pdf-border-normal">
                                {{date('F j, Y', strtotime($candidateJob->candidate->competencyTracking->completed_date ))}}
                            </span>
                        </div>
                    </div>
                </aside>
