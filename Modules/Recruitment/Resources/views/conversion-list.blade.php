                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="nav-item"><a href="#projectTab" aria-controls="projectTab" role="tab" class="nav-link" data-toggle="tab">Project Details</a></li>
                     <li role="presentation" class="nav-item"><a href="#certificateTab" aria-controls="certificateTab" role="tab"  class="nav-link" data-toggle="tab">Certificates</a></li>
                      <li role="presentation" class="nav-item"><a href="#expenseTab" aria-controls="expenseTab" role="tab"  class="nav-link" data-toggle="tab">Expense</a></li>
                ...
                <div class="tab-content tab-alignment">
                    <div role="tabpanel" class="tab-pane active" id="userTab">
                        ...
                        <div class="form-group" id="last_name">
                            <label for="last_name" class="col-sm-3 control-label">Last Name<span class="mandatory">*</span></label>
                            <div class="col-sm-8">
                    ...
                    <div role="tabpanel" class="tab-pane" id="employeeTab">
                        ...
                        <div class="form-group" id="employee_address">
                            <label for="employee_address" class="col-sm-3 control-label">Address<span class="mandatory">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group" id="employee_city">
                            <label for="employee_city" class="col-sm-3 control-label">City<span class="mandatory">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group" id="employee_doj">
                            <label for="employee_doj" class="col-sm-3 control-label">DOJ<span class="mandatory">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group" id="employee_dob">
                            <label for="employee_dob" class="col-sm-3 control-label">DOB<span class="mandatory">*</span></label>
                            <div class="col-sm-8">
                   ...
                   <div role="tabpanel" class="tab-pane" id="certificateTab">
                    ...
                    <div role="tabpanel" class="tab-pane" id="employmentTab">
                            ...
                            <div class="form-group" id="continuous_seniority">
                                <label for="continuous_seniority" class="col-sm-3 control-label nowrap">Continuous Seniority </label>
                                <div class="col-sm-8">
...
<script>
    ...
    placeholder :'Choose the Customer'
        ...
        var table = $('#conversion-table').DataTable({
            ...
            serverSide: true,
            responsive: false,
            ajax: "{{ route('recruitment.conversion.list') }}",
            headers: {
...
     });
       ...
       /* User Certificates - Remove - End */
        ...
        $('#user-form').submit(function (e) {
            ...
            url = "{{ route('recruitment.candidateEmployee.store',['module' => 'documents']) }}";
        ...
        $("#expiry_0>input").datepicker({
            ...
            var url = '{{ route("recruitment.candidate.show", ["id"=>":id"]) }}';
                ...
                success: function (data) {
                    ...
                    $('#myModal input[name="wage_expectations_from"]').val(data.user.candidate.wage_expectation.wage_expectations_from);
                      ...
                      $('#myModal select[name="role_id"] option[value="'+'guard'+'"]').prop('selected',true);
                       if((data.user.candidate.miscellaneous))
                       {
                      ...
                      {
                          if(data.user.candidate.candidate_jobs) {
                            $('#myModal select[name="project_no"] option[value="'+data.user.candidate.candidate_jobs.job.customer.id+'"]').prop('selected',true).trigger('change');
                            if ($('#myModal select[name="project_no"]').val() != "") {
                              $('#myModal input[name="project_name"]').val(data.user.candidate.candidate_jobs.job.customer.client_name);
                            }
                          }
                      }
                      else
                      {
                            $('#myModal select[name="project_no"] option[value="'+data.job_reassigned.customer.id+'"]').prop('selected',true).trigger('change');
                            if ($('#myModal select[name="project_no"]').val() != "") {
        ...
        $('#upload_profile_image').on('click', function(){
            ...
            resize.croppie('result', {
                ...
                var url = '{{ route("recruitment.candidate.profile-image-upload", ["candidate_id"=>":candidate_id"]) }}';
