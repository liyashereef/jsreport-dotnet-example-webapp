@if(!$candidate->personality_sums->isEmpty())
	<div class="form-group" id='personality_inventory_score'>
		<table class='table center' id='scoring-table'>
	    	...
	    	<tbody>
				@foreach($candidate->personality_inventories->chunk(count($candidate->personality_sums)/2) as $chunked_row)
					<tr>
						<th class='no-border'></th>
				...
				@foreach($candidate->personality_scores as $each_scores)
				<tr>
