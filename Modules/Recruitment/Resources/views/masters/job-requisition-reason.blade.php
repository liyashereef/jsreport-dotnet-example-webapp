...
<script>
    ...
    $(function () {
        ...
        var table = $('#reason-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.job-requisition-reason.list') }}",
            headers: {
        ...
        $('#reason-form').submit(function (e) {
            ...
            formSubmit($('#reason-form'), "{{ route('recruitment.job-requisition-reason.store') }}", table, e, message);
        });
        ...
        $("#reason-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.job-requisition-reason.single",":id") }}';
