...
<script>
    $(function () {
        ...
        var table = $('#feedback-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.candidate-feedback-lookup.list') }}",
            headers: {
        ...
        $('#feedback-form').submit(function (e) {
            ...
            formSubmit($('#feedback-form'), "{{ route('recruitment.candidate-feedback-lookup.store') }}", table, e, message);
        });
        /* Feedback Save - End*/
        ...
        $("#feedback-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.candidate-feedback-lookup.single",":id") }}';
        ...
        $('#feedback-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.candidate-feedback-lookup.destroy',':id') }}";
