...
<script>
    $(function () {
        ...
        var table = $('#training-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.training.list') }}",
            headers: {
        ...
        $('#training-form').submit(function (e) {
            ...
            formSubmit($('#training-form'), "{{ route('recruitment.training.store') }}", table, e, message);
        });
        ...
        $("#training-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.training.single",":id") }}';
        ...
        $('#training-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.training.destroy',':id') }}";
