...
<script>
    $(function () {
        ...
        var table = $('#security-clearance-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.security-clearance.list') }}",
            headers: {
        ...
        $('#security-clearance-form').submit(function (e) {
            ...
            formSubmit($('#security-clearance-form'), "{{ route('recruitment.security-clearance.store') }}", table, e, message);
        });
        ...
        $('#security-clearance-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.security-clearance.destroy',':id') }}";
        ...
        /* Security clearance Edit - Start */
         $("#security-clearance-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.security-clearance.single",":id") }}';
