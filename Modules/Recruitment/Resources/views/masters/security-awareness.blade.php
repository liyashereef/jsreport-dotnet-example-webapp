...
<script>
    $(function () {
        ...
        var table = $('#security-awareness-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.security-awareness.list') }}",
            headers: {
        ...
        $('#security-awareness-form').submit(function (e) {
            ...
            formSubmit($('#security-awareness-form'), "{{ route('recruitment.security-awareness.store') }}", table, e, message);
        });
        ...
        $("#security-awareness-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.security-awareness.single",":id") }}';
        ...
        $('#security-awareness-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.security-awareness.destroy',':id') }}";
