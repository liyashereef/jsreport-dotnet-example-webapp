...
<script>
    $(function () {
        ...
        var table = $('#type-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.candidate-assignment-type.list') }}",
            headers: {
        ...
        $('#type-form').submit(function (e) {
            ...
            formSubmit($('#type-form'), "{{ route('recruitment.candidate-assignment-type.store') }}", table, e, message);
        });
        ...
        $("#type-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.candidate-assignment-type.single",":id") }}';
        ...
        $('#type-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.candidate-assignment-type.destroy',':id') }}";
