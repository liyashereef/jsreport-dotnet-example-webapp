...
<script>
    $(function () {
        ...
        var table = $('#brand-awareness-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.brand-awareness.list') }}",
            headers: {
        ...
        $('#brand-awareness-form').submit(function (e) {
            ...
            formSubmit($('#brand-awareness-form'), "{{ route('recruitment.brand-awareness.store') }}", table, e, message);
        });
        ...
        $("#brand-awareness-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.brand-awareness.single",":id") }}';
        ...
        $('#brand-awareness-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.brand-awareness.destroy',':id') }}";
