...
<script>
    $(function () {
        ...
        var table = $('#rating-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.rate-experiences.list') }}",
            headers: {
        ...
        $('#rating-form').submit(function (e) {
            ...
            formSubmit($('#rating-form'), "{{ route('recruitment.rate-experiences.store') }}", table, e, message);
        });
        ...
        $("#rating-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.rate-experiences.single",":id") }}';
        ...
        $('#rating-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.rate-experiences.destroy',':id') }}";
