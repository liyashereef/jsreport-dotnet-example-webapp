...
@section('title', 'Competency Category')
...
<script>
    $(function () {
        ...
        var table = $('#competency-category-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.competency-matrix-category.list') }}",
            headers: {
        ...
        $('#competency-category-form').submit(function (e) {
            ...
            formSubmit($('#competency-category-form'), "{{ route('recruitment.competency-matrix-category.store') }}", table, e, message);
        });
        /* Posting data to Controller - End*/

        $("#competency-category-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.competency-matrix-category.single",":id") }}';
        ...
        $("#competency-category-table").on("click", ".delete", function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.competency-matrix-category.destroy',':id') }}";
