...
<script>
    $(function () {
        ...
        var table = $('#english-rating-table').DataTable({
            ...
            ajax: "{{ route('recruitment.english-rating.list') }}",
            headers: {
        ...
        $('#english-rating-form').submit(function (e) {
            ...
            formSubmit($('#english-rating-form'), "{{ route('recruitment.english-rating.store') }}", table, e, message);
        });
        /* Posting data to Controller - End*/

        $("#english-rating-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.english-rating.single",":id") }}';
        ...
        $("#english-rating-table").on("click", ".delete", function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.english-rating.destroy',':id') }}";
