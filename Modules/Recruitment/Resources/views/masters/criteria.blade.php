...
<script>
    ...
    $(function () {
        ...
        var table = $('#criteria-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: '{{ route('recruitment.criteria-lookups.list') }}',
            headers: {
         ...
         $('#criteria-form').submit(function (e) {
            ...
            formSubmit($('#criteria-form'), "{{ route('recruitment.criteria-lookups.store') }}", table, e, message);
        });
        ...
        $("#criteria-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.criteria-lookups.single",":id") }}';
        ...
        $('#criteria-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.criteria-lookups.destroy',':id') }}";
