    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group {{ $errors->has('rating') ? 'has-error' : '' }} row" id="rating">
...
<script>
    $(function () {
        ...
        var table = $('#competency-rating-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('recruitment.competency-matrix-rating.list') }}",
            headers: {
        ...
        $('#competency-rating-form').submit(function (e) {
            ...
            formSubmit($('#competency-rating-form'), "{{ route('recruitment.competency-matrix-rating.store') }}", table, e, message);
        });
        /* Posting data to Controller - End*/

        $("#competency-rating-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("recruitment.competency-matrix-rating.single",":id") }}';
        ...
        $("#competency-rating-table").on("click", ".delete", function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('recruitment.competency-matrix-rating.destroy',':id') }}";
