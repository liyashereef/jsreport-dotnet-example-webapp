            ...
            <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 contenttitle"
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 controlarea">
                        <select name="gender"
                            id="gender"
                            class="form-control inlineblock" disabled ="true" required>
                            <option value="">Select any</option>
                            <option value="male" @if ($candidate->gender=="1")
                                selected
                            @endif>Male</option>
                            <option value="female" @if ($candidate->gender=="2")
                                selected
                            @endif>Female</option>
                              <option value="other" @if ($candidate->gender=="3")
                                selected
                            @endif>Other</option>
            ...
            <div class="row">
                <div class="col-sm-3 contenttitle"
                    ...
                    <div class="col-sm-8"  id="shipping_address">
                        <textarea class="form-control" name="shipping_address"  rows="3" maxlength="1000">{{$candidate->candidateShipment?$candidate->candidateShipment->shippment_address:""}}</textarea>
                    </div>
            </div>
...
@include('recruitment::candidate.application.uniform_measurement_scripts')
