    ...
    <div class="row">
        ...
        <div class="tab-content">
            <div id="personality-inventory-questions" class="container-fluid tab-pane active">
                ...
                <div class="row">
	                <section class="candidate full-width">
	                    @include('recruitment::personality-inventory-partials.questions')
	                </section>
            	</div>
            </div>
            <div id="scoring" class="container-fluid tab-pane fade">
                ...
                <div class="row">
                    <section class="candidate full-width">
                        @include('recruitment::personality-inventory-partials.scoring')
                    </section>
                </div>
            </div>
            <div id="personal_analysis" class="container-fluid tab-pane fade">
                ...
                <div class="row">
                    <section class="candidate full-width">
                        @include('recruitment::personality-inventory-partials.personal-analysis')
                    </section>
                </div>
            </div>
        </div>
