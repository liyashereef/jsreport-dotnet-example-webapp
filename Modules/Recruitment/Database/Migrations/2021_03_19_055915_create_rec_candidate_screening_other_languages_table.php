...
class CreateRecCandidateScreeningOtherLanguagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql_rec')->create('rec_candidate_screening_other_languages', function (Blueprint $table) {
             $table->increments('id');
    ...
    {
        Schema::connection('mysql_rec')->dropIfExists('rec_candidate_screening_other_languages');
    }
}
