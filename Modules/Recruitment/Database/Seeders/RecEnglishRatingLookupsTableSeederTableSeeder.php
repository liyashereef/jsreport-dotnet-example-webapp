...
class RecEnglishRatingLookupsTableSeederTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        \DB::connection('mysql_rec')->table('rec_english_rating_lookups')->delete();
        \DB::connection('mysql_rec')->table('rec_english_rating_lookups')->insert([
            0 => [
                'id' => 1,
