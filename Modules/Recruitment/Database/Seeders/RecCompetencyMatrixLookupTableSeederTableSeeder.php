...
class RecCompetencyMatrixLookupTableSeederTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        \DB::connection('mysql_rec')->table('rec_competency_matrix_lookups')->delete();
        \DB::connection('mysql_rec')->table('rec_competency_matrix_lookups')->insert([
            0 => [
                'id' => 1,
...
4) Shows willingness to learn new methods, procedures, or techniques, resulting from departmental or company-wide change.
...
3) Helps and supports fellow employees in their work to contribute to overall success of the company.
...
5) Shares information and own expertise with others to enable them to accomplish group goals.',
            ...
            3 => [
                ...
                'definition' => 'Creates an atmosphere in which timely and high-quality information flows smoothly up and down, inside and outside of company. Encourages open expression of ideas and opinions.',
...
2) Sets and maintains high performance standards for self and others that support company\'s strategic plan and holds self and other team members accountable for achieving results.
...
4) Works to meet individual and company goals with positive regard, acknowledgment of, and cooperation with the achievement of others\' goals.
...
5) Offers compromises and trade-offs to others, as necessary, in exchange for cooperation.',
            ...
            13 => [
                ...
                'behavior' => '1) Knowledgeable about one\'s own department and about the company in general.
2) Demonstrates awareness of company\'s general goals and makes requests or decisions to support this awareness.
3) Knows how to use the company\'s formal and informal systems to get things done.
...
5) Keeps objectives related to company priorities at the top of one\'s own priorities and the priorities of one\'s work department or group.
...
5) Works to develop and maintain positive working relationships with co-workers by being punctual, keeping personal telephone calls to a minimum, and maintaining a pleasant work attitude.',
            ...
            17 => [
                ...
                'competency_matrix_category_id' => 1,
                'competency' => 'Quality',
                'definition' => 'Produces results or provides service that meets or exceeds company standards.',
...
5) Recognizes trends in theory and practice of one\'s own technical area and effectively prepares for anticipated changes.',
            ...
            21 => [
                ...
                'behavior' => '1) Communicates a compelling vision and need for change within one\'s department/group/company that generates excitement, enthusiasm, and commitment to the process.
...
6) Creates an environment that allows staff to feel motivated to work and interact.',
            ...
            23 => [
                ...
                'behavior' => '1) Takes into account the company as a whole when making decisions. Separates one\'s own interests from company\'s interests to make the best possible judgments for the company.
2) Identifies and pushes for solutions in which all parts of the company can benefit.
3) Builds consensus among one\'s peers in leadership.
4) Communicates key company priorities and how one\'s division or department contributes to achieving those priorities.
5) Shares goals with peers in the company to increase alignment, cooperation, and opportunities to collaborate.',
                'created_at' => date('Y-m-d'),
                'updated_at' => date('Y-m-d'),
            ],
            24 => [
...
5) Responds to opposing views in a non-defensive manner.',
            ...
            25 => [
                ...
                'definition' => 'Asserts own ideas and persuades others, gaining support and commitment from others; mobilizes people to take action, using creative approaches to motivate others to meet company goals.',
...
5) Develops and effectively uses networks, inside and outside the company.',
                'created_at' => date('Y-m-d'),
                'updated_at' => date('Y-m-d'),
            ],
            26 => [
...
4) Works to build consensus within the group/department/company.
