...
class RecCandidateAttachmentLookupsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::connection('mysql_rec')->table('rec_candidate_attachment_lookups')->delete();

        \DB::connection('mysql_rec')->table('rec_candidate_attachment_lookups')->insert(array(
            0 => array(
                'id' => 1,
