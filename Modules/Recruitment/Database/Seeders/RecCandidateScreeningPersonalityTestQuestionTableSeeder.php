...
class RecCandidateScreeningPersonalityTestQuestionTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        \DB::connection('mysql_rec')->table('rec_candidate_screening_personality_test_questions')->delete();

        \DB::connection('mysql_rec')->table('rec_candidate_screening_personality_test_questions')->insert(
            [
                0 => [
                    'id' => 1,
                ...
                18 => [
                    'id' => 19,
                    'question' => 'You are on a jury about to render a verdict on a person who robbed a bank to pay for a life saving surgery for their daughter. What do you do?',
                    'row' => 3,
                    'column' => 5,
