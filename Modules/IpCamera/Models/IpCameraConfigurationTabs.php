...
class IpCameraConfigurationTabs extends Model
{
    use SoftDeletes;
    ...
    {
        return $this->hasMany('Modules\IpCamera\Models\IpCameraConfigurationTabDetail', 'ip_camera_configuration_tab_id', 'id');
    }
}
