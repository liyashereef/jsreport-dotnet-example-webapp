...
var apiKey = "{{ config('globals.google_api_key') }}";
var marker_values =<?php echo json_encode($coordinates['result']);?>;
var map;
var drawingManager;
var placeIdArray = [];
var polylines = [];
...
// For marking Source and Destination
    var image = {
          url: "{{ asset('images/map_pointer.png') }}",
          size: new google.maps.Size(60, 62),
          origin: new google.maps.Point(0, 0),
          anchor: new google.maps.Point(32, 65)
        };
    for (var i = 0; i < marker_values.length; i++) {
        var marker_points = marker_values[i];
        var pointS = new google.maps.LatLng(marker_points[1],marker_points[2]);
        ...
        markerA = new google.maps.Marker({
          position: pointS,
          icon: image,
          title: marker_points[0],
          label: {text : marker_points[3], color: "white",x: '300', y: '300',fontWeight: "bold"},
          map: map
        })
       }
