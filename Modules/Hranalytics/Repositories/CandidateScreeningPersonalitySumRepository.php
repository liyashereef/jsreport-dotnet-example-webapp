...
use Modules\Hranalytics\Models\CandidateScreeningPersonalitySum;

class CandidateScreeningPersonalitySumRepository
{
    ...
    {
        $this->model = new CandidateScreeningPersonalitySum;
    }
