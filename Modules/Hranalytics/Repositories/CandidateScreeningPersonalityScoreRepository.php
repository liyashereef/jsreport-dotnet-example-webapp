...
use Modules\Hranalytics\Models\CandidateScreeningPersonalityScore;
use Modules\Hranalytics\Models\MyersBriggsIndicator;
...
use Modules\Hranalytics\Repositories\CandidateScreeningPersonalitySumRepository;

class CandidateScreeningPersonalityScoreRepository
{
    ...
    {
        $this->model = new CandidateScreeningPersonalityScore;
        $this->myers_briggs_indicator_model = new MyersBriggsIndicator;
        $this->inventory_repository = new CandidateScreeningPersonalityInventoryRepository;
        $this->sum_repository = new CandidateScreeningPersonalitySumRepository;
        $this->myers_briggs_personality_type_model = new MyersBriggsPersonalityType;
    }
            ...
            for ($column = 1; $column <= 7; $column = $column + 2) {
                ...
                switch ($column) {
                    case 1:
                        ...
                        break;
                    case 3:$sn = ($optionWithMoreWeightage) ? $myers_briggs_value[0] : 0;
                        break;
                    case 5:$tf = ($optionWithMoreWeightage) ? $myers_briggs_value[0] : 0;
                        break;
                    case 7:$jp = ($optionWithMoreWeightage) ? $myers_briggs_value[0] : 0;
                        break;
                }
            }
