...
class JobRequest extends Request
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'wage_low' => 'bail|required|numeric|max:999999',
            'wage_high' => 'bail|required|numeric|max:999999|greater_than_field:wage_low',
    ...
    public function messages()
    {
        return [
            ...
            'wage_low.required' => 'Please enter the low wage',
            'wage_high.required' => 'Please enter the high wage',
            'wage_high.greater_than_field' => 'The high wage should be greater than or equal to the low wage',
