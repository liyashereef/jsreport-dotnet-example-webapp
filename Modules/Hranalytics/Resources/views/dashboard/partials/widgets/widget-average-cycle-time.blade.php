...
<script>
    ...
    widgets.define('widgetAverageCycleTime',function(payload) {
        let wc; //widget container

        function generateContent() {
            let content =
            `<div style="padding: 20px;">
                <canvas id="averageCycleTime" height="125"></canvas>
            </div>`;
        ...
        function generateGraph(chartData) {
            ...
            let ctx = wc.find('#averageCycleTime');
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yAxes: [{
                            ...
                            scaleLabel: {
                                display: true,
                                labelString: 'Average Cycle Time'
                            },
                            ticks: {
                                beginAtZero: true
                            }
