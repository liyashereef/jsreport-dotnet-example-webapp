<!-- candidates by level of language fluency english -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.js" charset="utf-8"></script>
<script>
    //Use function name as camalCase version of WidgetTag
    //Always use let instead of var
    widgets.define('widgetCandidatesByLevelOfLanguageFluencyEnglish',function(payload) {
        let wc; //widget container

        function generateContent() {
            let content =
            `<div style="padding: 20px;">
                <canvas id="candidatesByLevelOfLanguageFluencyEnglish" height="125"></canvas>
            </div>`;
        ...
        function generateGraph(chartData) {
            ...
            let ctx = wc.find('#candidatesByLevelOfLanguageFluencyEnglish');
            let trendAnalysis = new Chart(ctx, {
                ...
                options: {
                    ...
                    title: {
                        display: false,
                        text: 'Candidates by Level of Language Fluency - English'
                    },
                    scales: {
                        xAxes: [{
                            gridLines: {
        ...
        function bindCustomWidgetTitle() {
            wc.find('.widget-candidates-by-level-of-language-fluency-english-tittle')
            .text('Candidates by Level of Language Fluency - English');
