<!-- candidates soft skill -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.js" charset="utf-8"></script>
<script>
    //Use function name as camalCase version of WidgetTag
    //Always use let instead of var
    widgets.define('widgetCandidatesSkillsSoftSkills',function(payload) {
        let wc; //widget container

        function generateContent() {
            let content =
            `<div style="padding: 20px;">
                <canvas id="candidatesSkillsSoftSkills" height="125"></canvas>
            </div>`;
        ...
        function generateGraph(chartData) {
            ...
            let ctx = wc.find('#candidatesSkillsSoftSkills');
        ...
        function bindCustomWidgetTitle() {
            wc.find('.widget-candidates-skills-soft-skills-tittle')
            .text('Candidates Skills - Soft Skills');
        }
