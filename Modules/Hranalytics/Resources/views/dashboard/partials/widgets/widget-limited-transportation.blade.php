...
<script>
    ...
    widgets.define('widgetLimitedTransportation',function(payload) {
        let wc; //widget container

        function generateContent() {
            let content =
            `<div style="padding: 20px;">
                <canvas id="limitedTransportation" height="125"></canvas>
            </div>`;
                ...
                options: {
                    ...
                    scales: {
                        ...
                        yAxes: [{
                            ...
                            scaleLabel: {
                                display: true,
                                labelString: 'Limited Transportation'
                            },
                            ticks: {
                                beginAtZero: true
                            }
