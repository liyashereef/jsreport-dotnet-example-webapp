...
<script>
    ...
    widgets.define('widgetWageExpectationsByRegion',function(payload) {
        let wc; //widget container

        function generateContent() {
            let content =
            `<div style="padding: 20px;">
                <canvas id="WageExpectationsByRegion" height="125"></canvas>
            </div>`;
            //..process
            return content;
        }
        ...
        function generateGraph(chartData) {
            ...
            let ctx = wc.find('#WageExpectationsByRegion');
            let trendAnalysis = new Chart(ctx, {
                ...
                options: {
                    ...
                    title: {
                        display: false,
                        text: 'Wage Expectations By Region'
                    },
                    scales: {
                        xAxes: [{
                            gridLines: {
