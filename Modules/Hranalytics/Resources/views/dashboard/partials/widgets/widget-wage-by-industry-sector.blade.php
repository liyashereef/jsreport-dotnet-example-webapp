...
<script>
    ...
    widgets.define('widgetWageByIndustrySector',function(payload) {
        let wc; //widget container

        function generateContent() {
            let content =
            `<div style="padding: 20px;">
                <canvas id="WageByIndustrySector" height="125"></canvas>
            </div>`;
            //..process
            return content;
        }
        ...
        function generateGraph(chartData) {
            ...
            let ctx = wc.find('#WageByIndustrySector');
