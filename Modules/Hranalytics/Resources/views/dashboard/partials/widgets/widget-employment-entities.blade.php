...
<script>
    ...
    widgets.define('widgetEmploymentEntities',function(payload) {
        let wc; //widget container

        function generateContent() {
            let content =
            `<div style="padding: 20px;">
                <canvas id="employmentEntities" height="125"></canvas>
            </div>`;
        ...
        function generateGraph(chartData) {
            ...
            let ctx = wc.find('#employmentEntities');
