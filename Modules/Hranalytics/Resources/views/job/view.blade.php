    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 text-sm-left">
                    <a class="btn submit" style="color: white;" target="_blank" href="{{ route('job.view-description',$job->id) }}" title="Click here for full job description">Full Job description</a>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 text-sm-left">
                    {{date('F j, Y', strtotime($job->requisition_date))}}
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 text-sm-left">
                    {{date('F j, Y', strtotime($job->required_job_start_date))}}
                </div>
            </div>
            ...
            <div class="form-group row">
                <div for="reason_dropdown_1" class="col-sm-6 pl-5">What are the minimum requirements for the role? (years) </div>
                <div class="col-sm-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3 text-sm-left">
                    Wage Low
                    <span class="orange"> :</span> ${{number_format((float)$job->wage_low, 2, '.', '')}}
                    <br/> Wage High
                    <span class="orange">:</span> ${{number_format((float)$job->wage_high, 2, '.', '')}}
                </div>
            </div>
            <div class="form-group row">
...
<script>
    $('#attachment-mandatory-form').submit(function (e) {
        ...
        $.ajax({
            ...
            url: "{{ route('job.attachment-settings',$job->id) }}",
            type: 'POST',
            data: formData,
