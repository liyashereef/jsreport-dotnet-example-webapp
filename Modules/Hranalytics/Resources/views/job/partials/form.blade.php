    ...
    @for($i=0;$i<10;$i++)
        ...
        <label for="experiences" class="col-sm-5 col-form-label">@if($i==0)What are the minimum requirements for the role? (years)@endif</label>
        <div class="col-sm-3">
    ...
    @endfor
        ...
        <div class="form-group row ">
            ...
            <div id="wage_low" class="col-sm-2 {{ $errors->has('wage_low') ? 'has-error' : '' }}">
                {{ Form::text('wage_low',old('wage_low', @$job->wage_low),array('placeholder'=>'Wage Low ($)','class'=>'form-control','required'=>true)) }}
                <div class="form-control-feedback"><span class="help-block text-danger align-middle font-12"></span>{!! $errors->first('wage_low', ':message') !!}</div>
            </div>
            <label class="col-sm-1 col-form-label">$</label>
            <div id="wage_high" class="col-sm-2 {{ $errors->has('wage_high') ? 'has-error' : '' }}">
                {{ Form::text('wage_high',old('wage_high', @$job->wage_high),array('placeholder'=>'Wage High ($)','class'=>'form-control','required'=>true)) }}
                <div class="form-control-feedback"><span class="help-block text-danger align-middle font-12"></span>{!! $errors->first('wage_high', ':message') !!}</div>
            </div>
        </div>
