...
<div class="form-group row {{ $errors->has('is_indian_native') ? 'has-error' : '' }}" id="is_indian_native">
    ...
    <div class="col-sm-7">
        {{ Form::select('is_indian_native',[null=>'This is a mandatory field, please enter the required information',"Yes"=>"Yes","No"=>"No"],old('is_indian_native',isset($candidateJob->candidate->miscellaneous->is_indian_native) ? $candidateJob->candidate->miscellaneous->is_indian_native :""),array('class' => 'form-control','required'=>TRUE)) }}
