...
<td  style="border-bottom: solid 1px #003a63;font-size: 14px;" >{{$candidateJob->candidate->city}}</td>
  ...
  <tr class="content-caps-bold-text">
    ...
    <tr class="content-normal-bold-text">
        <td colspan="4">Date of Application</td>
        <td colspan="2"
            style="border-bottom: solid 1px #003a63;font-size: 14px;"> {{date('d-m-Y', strtotime($candidateJob->submitted_date))}}</td>
    </tr>

    <tr class="content-normal-bold-text">
        <td colspan="4">What position code have you applied for ?</td>
        <td colspan="2"
            style="border-bottom: solid 1px #003a63;font-size: 14px;"> {{$candidateJob->job->unique_key}}</td>
    </tr>

    <tr class="content-normal-bold-text">
        <td colspan="4">Wage per Hour</td>
        <td colspan="2" style="border-bottom: solid 1px #003a63;font-size: 14px;">Low
            : {{number_format($candidateJob->job->wage_low,2)}} High
            : {{number_format($candidateJob->job->wage_high,2)}}</td>
    </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td style=" border-bottom: solid 1px #003a63;font-size: 14px;" colspan="2">From :
            ${{number_format($candidateJob->candidate->wageexpectation->wage_expectations_from, 2)}} To :
            ${{number_format($candidateJob->candidate->wageexpectation->wage_expectations_to, 2)}}</td>
    </tr>
    <tr class="content-normal-bold-text">
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;">{{$candidateJob->candidate->wageexpectation->wage_last_hours_per_week}} hours per week</td>
    </tr>
    <tr class="content-normal-bold-text">
    ...
    <tr class="content-normal-bold-text">
        <td colspan="4">What were the strengths of Securities</td>
        <td colspan="2"
    ...
    <tr class="content-normal-bold-text">
        <td colspan="4">What do you hope to get from Commissionaires that you feel Securitas was not providing?</td>
        <td colspan="2"
    ...
    @if($candidateJob->candidate->availability->current_availability == "Part-Time (Less than 40 hours per week)")
        <tr class="content-normal-bold-text">
            <td colspan="5">If only part time - please briefly explain your limitation</td>
            <td colspan="1"
                style=" border-bottom: solid 1px #003a63;font-size: 14px;">{{$candidateJob->candidate->availability->availability_explanation}}</td>
        </tr>
    @endif @if(isset($candidateJob->candidate->availability->days_required))

        <tr class="content-normal-bold-text">
            <td colspan="4">Which days are you available to work?<br><i>(Select those days you are available to work. If
                    you are joining our spares pool, we will expect you to work on the days and shifts you select)</i>
            </td>
            <td colspan="2"
                style=" border-bottom: solid 1px #003a63;font-size: 14px;">
                {!! implode(", ", json_decode($candidateJob->candidate->availability->days_required)) !!}
            </td>
        </tr>

    @endif @if($candidateJob->candidate->availability->shifts)
        <tr class="content-normal-bold-text">
            <td colspan="4">Which shifts are you willing to work?</td>
            <td colspan="2"
                style=" border-bottom: solid 1px #003a63;font-size: 14px;">
                {!! implode(", ", json_decode($candidateJob->candidate->availability->shifts)) !!}
            </td>
        </tr>
    @endif
    <tr class="content-normal-bold-text">
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;"> {{$candidateJob->candidate->experience->applied_employment }}</td>
    </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;">{{$candidateJob->candidate->experience->employed_by_corps }}</td>
    </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;"> {{$candidateJob->candidate->miscellaneous->veteran_of_armedforce }}</td>
    </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;">  {{$candidateJob->candidate->miscellaneous->spouse_of_armedforce}}</td>
    </tr>
    <tr class="light-heading orange label-b hr-line-label">
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;">  {{$candidateJob->candidate->miscellaneous->is_indian_native }}</td>
    </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;"> {{$candidateJob->candidate->miscellaneous->dismissed }}</td>
    </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;"> {{$candidateJob->candidate->miscellaneous->limitations }}</td>
    </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;">  {{$candidateJob->candidate->miscellaneous->criminal_convicted }}</td>
    </tr>
    ...
    @if($candidateJob->candidate->miscellaneous->criminal_convicted == "Yes")
        ...
        <tr class="content-normal-bold-text">
            ...
            <td colspan="2"
                style=" border-bottom: solid 1px #003a63;font-size: 14px;">{{$candidateJob->candidate->miscellaneous->disposition_granted}}</td>
        </tr>
    ...
    <tr class="content-normal-bold-text">
        ...
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;">  {{$candidateJob->candidate->miscellaneous->career_interest}}</td>
    </tr>

    <tr class="content-normal-bold-text">
        <td colspan="4">Would you consider other roles with Commissionaires beyond what you've applied for?</td>
        <td colspan="2"
            style=" border-bottom: solid 1px #003a63;font-size: 14px;">  {{$candidateJob->candidate->miscellaneous->other_roles }}</td>
    </tr>
