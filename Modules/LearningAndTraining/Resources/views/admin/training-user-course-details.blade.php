    ...
    <div class="row">
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 visit-log-padding">
            ...
            <div class="visit-log-card">
                ...
                Assigned
                <div class="visit-log-count-text"> @if(isset($course_details->CourseTrainingUserAllocationCount)){{$course_details->CourseTrainingUserAllocationCount->data_count}} @else {{0}} @endif</div>
            </div>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 visit-log-padding">
            ...
            <div class="visit-log-card">
                ...
                Completed
                <div class="visit-log-count-text">@if(isset($course_details->CourseTrainingUserAllocationCompletedCount)){{$course_details->CourseTrainingUserAllocationCompletedCount->data_count}} @else {{0}} @endif</div>
            </div>

        </div>
          <div class=" col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right" >
        <form action="{{route('learningandtraining.dashboard.course-details', $id)}}"  method="GET">
            <input type="submit"  value="Employees View" class="btn submit"  style="background-color: #f26222">
        </form>
    </div>
...
$(window).resize(function(){
    ...
    $(document).ready(function() {
        ...
        try {
            ...
            var view_url = '{{ route("learningandtraining.dashboard.course-details-users",[":id",":training_user_id"]) }}';
            view_url = view_url.replace(':id', {{$id}});
            view_url = view_url.replace(':training_user_id', 1);
            ...
            $('.manual-completion').click(function() {
               ...
               else
               {
                    ...
                    type: 'POST',
                    data:  {'employee_array': employee_array, 'course_id':course_id,'is_training_user':1},
