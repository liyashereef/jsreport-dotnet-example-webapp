...
@section('content')
<a href="{{ route('learningandtraining.dashboard.candidate-reports') }}" class="btn btn-primary blue" >Candidate Training Course Report</a>
    <div class="table_title">
        <h4>Training Course Report </h4>
    </div>
    <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            try {
                ...
                var view_url = '{{ route("learningandtraining.dashboard.reports_api") }}';
