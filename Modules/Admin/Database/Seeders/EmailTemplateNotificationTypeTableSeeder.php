...
class EmailTemplateNotificationTypeTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('email_templates')->insert(array(
            ...
            array(
                'type_id' => 26,
                'email_subject' => 'SECTURE Meet scheduling request user notification',
            ...
            array(
                'type_id' => 27,
                'email_subject' => 'SECTURE Meet scheduling cancellation notification',
                'email_body' => '<p>Hello {receiverFullName},</p><p>A CGL Meet Scheduling request
