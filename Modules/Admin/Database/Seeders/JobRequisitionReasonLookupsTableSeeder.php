...
class JobRequisitionReasonLookupsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('job_requisition_reason_lookups')->delete();

        \DB::table('job_requisition_reason_lookups')->insert(array(
            0 => array(
                'id' => 1,
                'parent_id' => 0,
