...
class SecurityClearanceRequest extends Request
{
    ...
    public function rules()
    {
        $id = request('id');
        return $rules = [
            'security_clearance' => "bail|required|max:255|unique:security_clearance_lookups,security_clearance,{$id},id,deleted_at,NULL",
        ];
    }
