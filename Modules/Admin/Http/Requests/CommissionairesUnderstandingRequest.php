...
class CommissionairesUnderstandingRequest extends Request
{
    ...
    {
        $id = request('id');
        //dd('req', request('commissionaires_understandings'));
        return $rules = [
            'commissionaires_understandings' => "bail|required|max:255|unique:commissionaires_understanding_lookups,commissionaires_understandings,{$id},id,deleted_at,NULL",
            'short_name' => "bail|nullable|max:100",
            'order_sequence' => "bail|required|integer|min:1|max:999|unique:commissionaires_understanding_lookups,order_sequence,{$id},id,deleted_at,NULL",
        ];
    }
