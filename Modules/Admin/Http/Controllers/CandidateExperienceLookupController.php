...
use Modules\Admin\Http\Requests\CandidateExperienceRequest;
use Modules\Admin\Repositories\CandidateExperienceLookupRepository;

class CandidateExperienceLookupController extends Controller
{
     ...
     * @return void
     */
    public function __construct(CandidateExperienceLookupRepository $candidateExperienceLookupRepository, HelperService $helperService)
    {
    ...
    {
        return view('admin::masters.candidate-experience');
    }
