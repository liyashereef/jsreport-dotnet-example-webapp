...
<script>
    $(function () {
        ...
        var table = $('#table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('course-category.list') }}",
            headers: {
        ...
        $('#form').submit(function (e) {
            ...
            formSubmit($('#form'), "{{ route('course-category.store') }}", table, e, message);
        });
        ...
        $("#table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("course-category.single",":id") }}';
        ...
        $('#table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('course-category.destroy',':id') }}";
