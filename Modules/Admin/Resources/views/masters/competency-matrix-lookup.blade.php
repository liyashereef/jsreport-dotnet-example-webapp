...
<script>
    $(function () {
        ...
        var table = $('#competency-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('competency-matrix.list') }}",
            headers: {
        ...
        $('#competency-form').submit(function (e) {
            ...
            formSubmit($('#competency-form'), "{{ route('competency-matrix.store') }}", table, e, message);
        });
        /* Posting data to Controller - End*/

        $("#competency-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("competency-matrix.single",":id") }}';
        ...
        $("#competency-table").on("click", ".delete", function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('competency-matrix.destroy',':id') }}";
