...
<script>
    $(function () {
        ...
        var table = $('#commissionaires-understanding-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('commissionaires-understanding.list') }}",
            headers: {
        ...
        $('#commissionaires-understanding-form').submit(function (e) {
            ...
            formSubmit($('#commissionaires-understanding-form'), "{{ route('commissionaires-understanding.store') }}", table, e, message);
        });
        ...
        $("#commissionaires-understanding-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("commissionaires-understanding.single",":id") }}';
        ...
        $('#commissionaires-understanding-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('commissionaires-understanding.destroy',':id') }}";
