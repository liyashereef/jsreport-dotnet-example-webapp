...
<h1>Schedule Assignment Types</h1>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }} row" id="type">
...
<script>
    $(function () {
        ...
        var table = $('#type-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('schedule-assignment-type.list') }}",
            headers: {
        ...
        $('#type-form').submit(function (e) {
            ...
            formSubmit($('#type-form'), "{{ route('schedule-assignment-type.store') }}", table, e, message);
        });
        /* Posting data to ExperienceController - End*/

        $("#type-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("schedule-assignment-type.single",":id") }}';
        ...
        $('#type-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('schedule-assignment-type.destroy',':id') }}";
