...
<script>
    $(function () {
        ...
        var table = $('#experience-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('candidate-experience.list') }}",
            headers: {
        ...
        $('#experience-form').submit(function (e) {
            ...
            formSubmit($('#experience-form'), "{{ route('candidate-experience.store') }}", table, e, message);
        });
        /* Experience Save - End*/
        ...
        $("#experience-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("candidate-experience.single",":id") }}';
        ...
        $('#experience-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('candidate-experience.destroy',':id') }}";
