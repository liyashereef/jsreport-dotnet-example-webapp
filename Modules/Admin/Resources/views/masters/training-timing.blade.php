    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group {{ $errors->has('timings') ? 'has-error' : '' }} row" id="timings">
...
<script>
    $(function () {
        ...
        var table = $('#timing-table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('training-timing.list') }}",
            headers: {
        ...
        $('#timing-form').submit(function (e) {
            ...
            formSubmit($('#timing-form'), "{{ route('training-timing.store') }}", table, e, message);
        });
        ...
        $("#timing-table").on("click", ".edit", function (e) {
            var id = $(this).data('id');
            var url = '{{ route("training-timing.single",":id") }}';
        ...
        $('#timing-table').on('click', '.delete', function (e) {
            var id = $(this).data('id');
            var base_url = "{{ route('training-timing.destroy',':id') }}";
