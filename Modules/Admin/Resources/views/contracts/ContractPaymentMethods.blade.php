    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                 ...
                 <div class="form-group row" id="paymentmethodtitle">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (o) {
                        ...
                        actions += '<a href="#" class="edit editreason {{Config::get('globals.editFontIcon')}}" data-id=' + o.id + ' data-change-title=\'' + o.paymentmethod + '\' ></a>'
                        
                        @can('lookup-remove-entries')
                            actions += '<a href="#" class="delete deletereason  {{Config::get('globals.deleteFontIcon')}}" data-id=' + o.id + ' data-change-title=\'' + o.paymentmethod + '\' ></a>';
                            @endcan
                        return actions;
                        },
                }
