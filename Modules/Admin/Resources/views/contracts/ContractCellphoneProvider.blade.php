            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (o) {
                        ...
                        actions += '<a href="#" class="edit editreason fa fa-pencil" data-id=' + o.id + ' data-change-title=\'' + o.providername + '\' ></a>'

                        @can('lookup-remove-entries')
                            actions += '<a href="#" class="delete deletereason fa fa-trash-o" data-id=' + o.id + ' data-change-title=\'' + o.providername + '\' ></a>';
                            @endcan
                        return actions;
                        },
                }
