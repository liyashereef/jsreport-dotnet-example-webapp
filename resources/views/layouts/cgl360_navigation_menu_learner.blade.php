        ...
        @can('learner_admin')
            <li>
                <a href="{{ route('learningandtraining.dashboard') }}"  class="dropdown-toggle">
                    ...
                    <i title="Compliance " class="fa fa-book" aria-hidden="true"></i>
                    <span>Dashboard </span>
                </a>
            </li>
            ...
            <li>
                <a href="homeSubmenu" data-toggle="dropdown" aria-expanded="false" class="dropdown-toggle">
                    ...
                    <i title="Recruiting " class="fa fa-university" aria-hidden="true"></i>
                    <span>Course </span>
                </a>
                <ul class="dropdown-menu first-menu-list" role="menu" aria-labelledby="menu1">

                        <li class="dropdown-submenu">
                            <a  href="{{ route('course-admin') }}">Create Course</a>

                        </li>
                        <li class="dropdown-submenu">
                            <a  href="{{ route('course-category-admin') }}">Create Categories</a>
            ...
            <li>
                <a href="homeSubmenu" data-toggle="dropdown" aria-expanded="false" class="dropdown-toggle">
                    <i title="Compliance " class="fa fa-users" aria-hidden="true"></i>
                    <span>Team </span>
                </a>
                <ul class="dropdown-menu first-menu-list" role="menu" aria-labelledby="menu1">
