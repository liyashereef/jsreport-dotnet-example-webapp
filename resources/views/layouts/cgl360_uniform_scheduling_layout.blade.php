...
<head>
    <title>@yield('title', config('app.name', 'CGL360 Uniform Scheduling') ) </title>
    <meta charset="utf-8">
        ...
        <nav class="navbar navbar-expand-md head-bg">
            @if(\Auth::user())
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <a href="{{ route('uniform.booking-page') }}"><img src="{{asset('images/logo.png') }}"></a>
                    </div>
                    <div class="col-md-9">
                        ...
                        <div class="dropdown">
                            <span class="dropdown-toggle user-profile" data-toggle="dropdown">
                                <div class="d-flex flex-row-reverse align-items-center">
                                    ...
                                    <div class="info">
                                        ...
                                        <p class="user-time" style="">It's {{ \Carbon::now()->format('l F d, Y') }}  </p>
                            ...
                            <ul class="dropdown-menu dropdown-content">
                                ...
                                <li style="cursor:pointer" onclick="if(confirm('Are you sure to logout?')){ event.preventDefault(); document.getElementById('logout-form').submit(); }"><a>Logout</a>
                                    <form id="logout-form" action="{{ route('uniform.logout') }}" method="POST"
                                        style="display: none;">
                                        {{ csrf_field() }}
                                    </form></li>
                            </ul>
