...
<body>
        <nav class="navbar navbar-expand-md head-bg" id="mainnavbar"
        style="background: #E76528;display: none !important;"
         {{-- style="" --}}
         >

                <div class="row align-items-center" style="height: 176px">

                    <div class="col-md-12" >
                        <img src="{{asset("images/cgl_logo_white.png")}}" alt=""
                         style="width: 100%">
                    </div>
                </div>
        ...
        <div class="content-div" style="height: 600px;
        overflow-y: scroll;
        overflow-x: hidden;
    ">
            @yield('content')
